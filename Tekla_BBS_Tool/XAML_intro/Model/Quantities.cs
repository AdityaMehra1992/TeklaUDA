...
namespace XAML_intro.Model
{
    public class Quantities
    {
        ...
        public Quantities(Part P, int unit)
        {
            this._partName = P.TeklaPartName;
            this._material = P.Material;
            this._volume = P.Volume * unit;
            this._partWeight = P.Weight * unit;
            this._unit = unit;
        ...
        public double Weight { get { return _partWeight; } }
